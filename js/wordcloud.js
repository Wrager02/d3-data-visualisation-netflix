...
d3.csv("https://raw.githubusercontent.com/Wrager02/d3-test/master/data/netflix_titles_v2.csv", function (d) {
    d.forEach(entry => {
        ...
        title.split(/\s+/).forEach(word => {
            if (word === "THE" || word ===  "OF" || word === "" || word ===  "A" || word ===  "IN" || word ===  "AND" || word ===  "TO" || word ===  "MY" || word ===  "ON" || word ===  "FOR" || word ===  "WITH" || word ===  "I" || word ===  "YOU" || word ===  "ME" || word ===  "FROM" || word ===  "IS" || word ===  "AT" || word ===  "DE" || word ===  "LA" || word ===  "ALL" || word ===  "EL" || word ===  "IT" || word ===  "NO" || word ===  "AN" || word ===  "WE") {
                return
            }
...
setTimeout(function () {
    ...
    // })
    //
    // console.log(values.forEach(element => {
